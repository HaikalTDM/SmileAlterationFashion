...
export default function CustomClothesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = `*CUSTOM CLOTHES ORDER*
    ...
    <main className="min-h-screen bg-white">
      ...
      <header className="border-b border-neutral-200 bg-white sticky top-0 z-10">
        <div className="px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-lg font-semibold text-neutral-900">Custom Clothes</h1>
        </div>
      </header>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Describe what you want, include measurements if available..."
              rows={6}
              required
            />
          </div>
          ...
          <div>
            ...
            {images.length < 5 && (
              <label className="block w-full border-2 border-dashed border-neutral-300 rounded-lg p-8 text-center cursor-pointer hover:border-neutral-400 transition-colors">
                ...
                <p className="text-sm text-neutral-600">Tap to add images</p>
